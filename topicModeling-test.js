...
if (process.argv.length < 3) {
	console.log('node topicModeling-text.js [input text] [action (stopwords|stemwords|stopwords_stem|topic_modeling)]');
...
if (process.argv[3] && process.argv[3] == 'stopwords') {
	...
	console.log(TopicModeling.createModel(process.argv[2]));
}
